...
namespace Kanboard\Plugin\TaskSwimlaneChangeLessThanDays\Action;
 ...
 */
class TaskSwimlaneChangeLessThanDays extends Base
{
    /**
    ...
    public function doAction(array $data)
    {
        ...
        foreach ($data['tasks'] as $task) {
            if ( ($task['swimlane_id'] == $this->getParam('src_swimlane_id')) &&
                 //Logic: The date due is prior to today + the number of days specified in the plugin
                 //           making this task due in LESS than xx days
