...
return array(
    ...
    'I want to receive notifications only for those projects:' => 'می خواهم آگاه سازی ها را فقط برای این پروژه ها دریافت کنم:',
    ...
    '%s updated a comment on the task %s' => '%s نظرخود را در مورد  کار بروز کرد %s', //*new by mahdi hezaveh #
    '%s commented the task %s' => '%s در مورد کار اظهار نظر کرد %s', //*new by mahdi hezaveh #
    ...
    'The currency rate have been added successfully.' => 'نرخ واحد پول با موفقیت افزوده شد.',
    ...
    'The field "%s" have been updated' => 'فیلد "%s" بروز رسانی شد',
