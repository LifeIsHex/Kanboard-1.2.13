...
function IsValidDate(date) { //new by mahdi hezaveh #
    ...
    var regex = /\d{4}\/\d{1,2}\/\d{1,2}/; // فرمت تاریخ در تنظیمات باید YYYY/dd/mm باشد
...
function replaceAllDatesByPersianDates() {
    ...
    var dateLiElements = $("li:contains(تاریخ):contains('/'), .task-date, .activity-date, .gDate, .gDateTime, .comment-date, li, td "); //<td> new by mahdi hezaveh #
