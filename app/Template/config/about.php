...
<div class="panel">
    <ul>
        ...
        <hr>
        <li> <!-- new by mahdi hezaveh # -->
            نسخه تغییر یافته:
            <strong>1.3.1</strong>
        </li>
        <li> <!-- new by mahdi hezaveh # -->
            نویسنده:
            <strong>مهدی هزاوه</strong>
        </li>
        <li> <!-- new by mahdi hezaveh # -->
            وب سایت رسمی:
            <a href="http://mytaskboard.ir/" target="_blank" rel="noreferer">http://mytaskboard.ir/</a>
        </li>
    </ul>
</div>
...
<div class="panel my-ltr"> <!-- new by mahdi hezaveh # -->
